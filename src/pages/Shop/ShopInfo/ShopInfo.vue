  ...
  <div class="shop-info" ref="shopInfo">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="activityClasses[support.type]" v-for="support in shopInfo.supports">
  ...
  export default {
    ...
    methods:{
      _initScroll(){
        ...
        const ulWidth = (liWidth+space)*count-space+"px"
        console.log(ulWidth)
