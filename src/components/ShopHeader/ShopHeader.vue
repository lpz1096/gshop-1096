<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage:`url(${shopInfo.bgImg})`}">
      <a class="back">
        <i class="iconfont icon-arrow-right-copy" @click="$router.back()"></i>
      </a>
    </nav>
    <div class="shop-content" @click="showShopInfo=!showShopInfo">
    ...
    <div class="shop-header-discounts" @click="showShopSupports = !showShopSupports" v-if="shopInfo.supports">
    ...
    <div class="shop-brief-modal" v-show="showShopInfo">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="showShopInfo=!showShopInfo">
          <span class="iconfont icon-quxiao"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>
    <div class="activity-sheet" v-show="showShopSupports">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li class="activity-item" v-for="support in shopInfo.supports" :class="activityClasses[support.type]">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="showShopSupports = !showShopSupports">
          <span class="iconfont icon-quxiao"></span>
        </div>
      </div>
